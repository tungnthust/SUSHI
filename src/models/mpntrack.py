...
class MOTMPNet(nn.Module):
    ...
    def _build_core_MPNet(self, model_params, encoder_feats_dict):
        ...
        self.reattach_initial_nodes = model_params['reattach_initial_nodes'] # False: Determines whether initially encoded node feats are used during node updates
        self.reattach_initial_edges = model_params['reattach_initial_edges'] # True: Determines whether initially encoded edge feats are used during node updates
